...
export DNS_Settings="223.5.5.5 114.114.114.114 8.8.8.8 1.1.1.1"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
export Broadcast_Ipv4="192.168.100.0"                   # 设置 IPv4 广播(填入您的IP为启用)(填0为不作修改)
